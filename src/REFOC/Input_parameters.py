...
evfile = r'../../INPUT/evlist_ex'
#evfile = r'../INPUT/evlist_test'
# location file for all earthquakes 
locfile = r'../../INPUT/sparta_relocation.txt'
# station file 
stafile = r'../../INPUT/station.txt'
# polarity reversal file
# plfile = None#r'../INPUT/merged.reverse_7char'
...
vm_list = ["Chaoman_interpolated_velocity_model"]
#--------------------------------------------------------------------------
